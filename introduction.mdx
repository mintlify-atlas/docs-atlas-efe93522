...
description: "cj81499's AoC repository holds Python solutions for 2015–2025, a shared utility library, strict type checking, and full test coverage for every solved puzzle."
---
...
<CardGroup cols={2}>
  <Card title="Repository Overview" icon="folder-open" href="#repository-overview">
  ...
  <Card title="Utility Library" icon="wrench" href="#the-solve-entry-point">
    The `aoc_cj.util` subpackage — shared helpers used across all years.
  </Card>
  <Card title="Solutions by Year" icon="calendar" href="#dependencies">

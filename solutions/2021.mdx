...
sidebarTitle: "2021"
description: "Python solutions for Advent of Code 2021 by cj81499, covering 22 days with tested, type-checked implementations."
---

Advent of Code 2021 sent participants on an underwater adventure to retrieve Santa's sleigh keys from the ocean floor. Of the 25 days published, **22 days are fully solved** (both parts), with Day 19 (Beacon Scanner) remaining unsolved. All solved days include passing tests and type-checked implementations. The year features a satisfying mix of simulation puzzles, recursive algorithms, and binary packet parsing.
